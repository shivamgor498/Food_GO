    ...
    color: white;
			...
			<%		   
				...
				try
				{
					String sql ="select * from orders o, restaurant r where r.rest_id=o.rest_id "
							+" and o.order_status=\"Picked Up\" and o.cust_email=\""+id+"\"";
			...
			<table id="customers">
			  ...
			  <tr>
			    ...
			    <td><%=resultSet.getString("delivery_order_time")%></td>
			  </tr>
			</table>
			<table id="customers">
			  <tr>
			...
			<%
					String sql1 ="select (i.item_qty*m.item_price), i.item_id,m.item_name,i.item_qty from items_ordered i,orders c,menu m where i.item_id=m.item_id and c.order_status=\"Picked Up\" "
