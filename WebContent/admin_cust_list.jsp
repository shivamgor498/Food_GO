...
<body>
    ...
    <div class="wrapper">
        ...
        <nav id="sidebar"  class="active">
            ...
            <a href="admin_home.jsp"><img src="images/admin_logo.jpg" style="width: 55px;
        ...
        <div id="content">
            ...
            <div class="line"></div>
            	<p align="right">
            	<u>
				<a href="Cust_list_pdf" style="color : rgb(89, 137, 214);font-size:25px;margin-right:50px;">Get PDf</a>
				</u></p>
...
<center>
	...
	<%
	 	...
	 	if(request.getParameter("cust_name")==null){
	 		...
	 		temp=request.getParameter("cust_name");	 		
	 	}
	 %>
    <form action="admin_cust_list.jsp">
    <input type="text" name="cust_name" autofocus onfocus="var temp_value=this.value; this.value=''; this.value=temp_value"
    value ="<%=temp%>" placeholder="Search Customers by name..." autocomplete="off" >
    </form>
    <u><a href="admin_cust_list.jsp?show=all" style="color : rgb(89, 137, 214)">List all</a></u>

       <br><br>
        <table id="customers" style="margin-bottom: 80px;">
            <tr>
                <th>Id</th>
                <th>Name</th>
            </tr>
		        ...
		        String sql=null;
				if (request.getParameterMap().containsKey("cust_name")) {
                    String cust_name = request.getParameter("cust_name");
                    System.out.println(cust_name);
		        	sql="select * from cust where cust_name LIKE '%"+cust_name+"%'";
                }
                else{
            ...
            <tr>
                ...
                <td style="color:blue;"><a href="admin_cust_info.jsp?cust_email=<%=rs.getString("cust_email")%>"><u><%=rs.getString("cust_name")%></u></a></td>
            </tr>
		    	<%
					}
	        	%>
