	...
	<h3> Order History </h3>
       ...
       <br><br>
        <table id="past_order">
          ...
          String sql="select orders.order_id,restaurant.rest_name,orders.delivery_order_time,orders.order_time,orders.order_total,orders.order_status from orders inner join restaurant where orders.rest_id=restaurant.rest_id and orders.cust_email='"+request.getParameter("cust_email")+"'";
          ...
          %>
				<tr>
                <td style="color:blue"><a href="admin_cust_order_history_detail.jsp?order_id=<%=rs.getString("orders.order_id")%>"><u><%=rs.getString("order_id")%></u></a></td>
                <td><%=rs.getString("restaurant.rest_name")%></td>
                <td><%=rs.getString("orders.delivery_order_time")%></td>
                <td><%=rs.getString("orders.order_time")%></td>
                <td><%=rs.getString("orders.order_total")%></td>
                <td><%=rs.getString("orders.order_status")%></td>
            </tr>
          <%
          }
            %>
