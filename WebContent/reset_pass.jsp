...
<body class="bod">
  <div class="logbox">
    ...
    <form name="myform" method="post" action="Reset_pass" onsubmit="return validations()">
...
we will reset your password.</pre>
      <p>New Password : </p><input type="text" name="new_password" placeholder="Enter your new password here" size="50">      
