...
<body data-target=".navbar-fixed-top">
		...
		<nav id="menu" class="navbar navbar-default navbar-fixed-top">
		  <div class="container"> 
		    ...
		    <div class="navbar-header">
		      ...
		      <a class="navbar-brand page-scroll " href="rest_mainpage.jsp">FoodGo</a>
	...
	<div></div>
		<h3>
			Hey there <font color="#45a049">${remail}</font>
		</h3>
</div>
	</center>
	<div>
...
<table class="table">
        <thead><!--head of tables-->
            <tr>
                ...
                <th><p style="color: #000" class="text-center">Item type</p></th>
                <th><p style="color: #000" class="text-center">Item price</p></th>
                <th></th>
            </tr>
        </thead>
		<%
	...
	%>		
                    <tbody><!--menu1-->
                        <tr>
                            <td class="col-md-4 text-center" style="color: dodgerblue"><%=resultSet.getString("item_name")%></p></h4></td>
                            <td class="col-md-4 text-center" style="color: dodgerblue"><%=resultSet.getString("item_type") %></p></h4></td>
                            <td class="col-md-2 text-center" style="text-align: center; color: dodgerblue"><%=resultSet.getString("item_price")%></td>
                            <td class="col-md-2 text-center" style="color: dodgerblue"><a href="rest_update_menu.jsp?item_id=<%=resultSet.getString("item_id")%>">Update</td>
                        </tr>
                    </tbody>
            <% 
					}//outer while
