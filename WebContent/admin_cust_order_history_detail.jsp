	...
	<h3> Order Detail </h3>
       ...
       <br><br>
        <table id="past_order">
          ...
          String sql="select menu.item_id,menu.item_name,items_ordered.item_qty,menu.item_price,menu.item_type from items_ordered inner join menu where items_ordered.item_id=menu.item_id and items_ordered.order_id="+request.getParameter("order_id");
          ...
          %>
            <tr>
                <td><%=rs.getString("menu.item_id")%></td>
                <td><%=rs.getString("menu.item_name")%></td>
                <td><%=rs.getString("items_ordered.item_qty")%></td>
                <td><%=rs.getString("menu.item_price")%></td>
                <td><%=rs.getString("menu.item_type")%></td>
            </tr>
          <%
          }
            %>
