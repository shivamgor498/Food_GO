...
<div class="container">
			...
			<div class="col-xs-12">
	    		...
	    		<div class="col-xs-12 col-md-3">CUSTOMER EMAIL</div>
	    		<div class="col-xs-12 col-md-2">ORDER TIME</div>
	    		<div class="col-xs-12 col-md-1">ORDER TOTAL</div>
	    		<div class="col-xs-12 col-md-2">ORDER STATUS</div>
	    		<div class="col-xs-12 col-md-2">ORDER DELIVERY TIME</div>
	    	</div>
	    	</div>
			<%		   
				...
				try
				{
					String sql ="select * from orders o, restaurant r where r.rest_id=o.rest_id and o.order_status=\"Picked Up\" "
						+"and o.rest_id="+id ;
			...
			%>	
	    		...
	    		<div class="col-xs-12">
	     		<br>
						 	<div class="col-xs-12 col-md-2"><%=resultSet.getString("order_id")%></div>
				            <div class="col-xs-12 col-md-3"><%=resultSet.getString("cust_email")%></div>
							<div class="col-xs-12 col-md-2"><%=resultSet.getString("order_time")%></div>
				            <div class="col-xs-12 col-md-1"><%=resultSet.getString("order_total")%></div>
				            <div class="col-xs-12 col-md-2"><%=resultSet.getString("order_status")%></div>
				            <div class="col-xs-12 col-md-2"><%=resultSet.getString("delivery_order_time")%></div>
				            <div class="row">
							<div class="col-xs-12">
					    		<div class="col-xs-12 col-md-2">ITEM NAME</div>
					    		<div class="col-xs-12 col-md-2">ITEM QTY</div>
					    		<div class="col-xs-12 col-md-2">ITEM TOTAL</div>
			...
			<% 
					String sql1 ="select (i.item_qty*m.item_price), i.item_id,m.item_name,i.item_qty from items_ordered i,orders c,menu m where i.item_id=m.item_id and"+ 
							" c.order_status=\"Picked Up\" and i.order_id=c.order_id and c.order_id="+k+" and c.rest_id="+id ;
					statement1=con.createStatement();
					resultSet1 = statement1.executeQuery(sql1);
					while(resultSet1.next()){
			%>			
			&emsp;&emsp;&emsp;&emsp;<div class="col-xs-12 col-md-2"><%=resultSet1.getString("item_name")%></div>
			&emsp;&emsp;&emsp;&emsp;<div class="col-xs-12 col-md-2"><%=resultSet1.getString("item_qty")%></div>			
			&emsp;&emsp;&emsp;&emsp;<div class="col-xs-12 col-md-2"><%=resultSet1.getString(1) %></div>
									<div class="col-xs-12 col-md-2"></div>
									<div class="col-xs-12 col-md-2"></div>
									<div class="col-xs-12 col-md-2"></div>
					</div>
  ...
  <div class="container text-center">
    <div class="col-md-3">
      ...
      <div class="contact-item">
        <a href="rest_location.jsp"><p>Add your restaurant</p></a>
