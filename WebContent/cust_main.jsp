...
<meta charset="utf-8">
	...
	<link rel="stylesheet" type="text/css" href="css/rest_search.css">
		...
		<nav id="menu" class="navbar navbar-default navbar-fixed-top" style="background-color: #262626; height: 80px;">
		  <div class="container">
		    ...
		    <div class="navbar-header">
		      ...
		      <a class="navbar-brand " href="mainpage_cust.jsp">FoodGo</a>
		      <font color="white" size="5">WELCOME TOoo FOOD GO <span style="color:  #8eb640;"> ${cname}</span></font><br>
		    </div>	
	<!-- navbar -->
		    <div>
		      <ul class="nav navbar-nav navbar-right">
		        <li><a href="mainpage_cust.jsp#about" >About</a></li>
		        <li><a href="mainpage_cust.jsp#restaurants" >Restaurants</a></li>
		        <li><a href="mainpage_cust.jsp#portfolio" >Filters</a></li>
		        <li><a href="mainpage_cust.jsp#team" >team</a></li>
		        <%
		        if(session.getAttribute("cemail")==null)
				{		        	
				%>
...
<div class="container">
  <div class="jumbotron" style="background-color: #262626;color: white">
		...
		<input class="input" type="text" name="input" autofocus="autofocus" placeholder="Search by name,address,rating..." size="30" autocomplete="off" value="${input}" onfocus="var temp_value=this.value; this.value=''; this.value=temp_value">
		<span class="underline" style="top:171px"></span>

					<br><button type="submit"  style="background-color: #262626;border-color: #262626;"></button>
		   </div>
		</form>
			...
			Connection con = obj.get();
				...
				<div class="row">
					<div class="col-sm-5">
						...
						<a href="restDisp.jsp?rest_id= <%=resultSet.getString("rest_id")%>">
  ...
  <div class="container text-center">
    <div class="col-md-3">
      ...
      <div class="contact-item">
        ...
        <a href="signup.jsp"><p>View your Restaurant</p></a>
      </div>
    </div>
    <div class="col-md-3">
      <a href="welcome.html"><h3>Find restaurants</h3></a>
      <div class="contact-item">
	     <div class="col-md-6">
	     </div>
	    <div class="col-md-6">
	    </div>
	    <form  name="myform1" method="get" action="mapp.jsp" ><button type="submit" class="btn btn-custom btn-lg">Find On Map</button></form>
